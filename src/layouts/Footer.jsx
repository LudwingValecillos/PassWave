...
function Footer() {
  return (
    <>
    <img src="/src/assets/wave-haikei.svg" alt="" className="" />


    <footer className="bg-[#05C7F2] p-10">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 bg-[#ffffffe3] rounded-full">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-center text-xl leading-relaxed ">
