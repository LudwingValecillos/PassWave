...
function SketchCardEvent(props) {
  ...
  return (
    <article className="w-[400px] h-[550px] flex flex-col justify-between p-6 bg-[#F2BB13] hover:bg-[#f2ba13a6] border-4 duration-300 hover:hover:scale-105 border-black rounded-lg shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
      <div className="relative">
        ...
        />
        <div className="absolute top-2 right-2 bg-white text-black font-bold py-1 px-3 text-xs rounded-full transform rotate-12 border-2 border-black"  data-aos="fade-right">
          New!
        </div>
      </div>

      <div className="mt-4 space-y-3">
        <h2 className="text-xl font-bold text-center  text-black bg-white rounded-full py-2 border-2 border-black duration-100 hover:bg-black hover:text-white" data-aos="fade-left">
          {props.title}
        </h2>

        <div className="flex items-center justify-center gap-2 text-black bg-white rounded-full py-2 border-2 border-black duration-100 hover:bg-black hover:text-white" data-aos="fade-right">
      ...
      <div className="grid grid-cols-3 gap-3 mt-4" >
        <div className="bg-white rounded-md p-3 border-2 border-black" data-aos="flip-left"
