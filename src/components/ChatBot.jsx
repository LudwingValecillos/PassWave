...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, stands are available for rent, and we offer two types of stands.",
  },
  {
    ...
    <div className="fixed bottom-4 right-4 z-50">
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-gradient-to-r from-[#f28d35] to-[#f2bb13] text-white p-4 rounded-t-lg flex justify-between items-center">
              <h3 className="font-bold text-xl">Friendly RoboHelper</h3>
              <button
                onClick={() => setIsOpen(false)}
                className="bg-gradient-to-r from-[#f28d35] to-gray-500 text-white hover:bg-gradient-to-l hover:from-gray-500 hover:to-[#f28d35] transition-colors p-2 rounded-full"
              >
                <svg
            ...
            <div className="p-4 flex flex-col items-center">
              ...
              <div className="w-full bg-white rounded-lg p-4 shadow-md mb-4">
                <p className="text-gray-700 text-center">
                  {currentAnswer ||
                    "Hello! I'm your friendly RoboHelper. Click on a question below and I'll be happy to assist you!"}
                </p>
              </div>
