...
const LabelInput = ({ name, title, onChange }) => {
  ...
  return (
    ...
    >
      ...
      />
      <span className="pointer-events-none font-bold absolute start-2.5 top-0 -translate-y-1/2 bg-[#C4DFFE] px-1 text-xs text-gray-700 transition-all peer-placeholder-shown:top-1/2 
